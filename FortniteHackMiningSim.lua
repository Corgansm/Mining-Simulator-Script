...
local legit = gui:Tab("Lebron JaHames")
...
local purchasedBackpack = 3  -- Default to the lowest-priced backpack that has been purchased
local aimbot = legit:Sector("teleport", "Left")
aimbot:Element("ToggleKeybind", "AutoSell")
aimbot:Element("Button", "BuyBackpack", {}, function()
    local Amount = GetCoinsAmount()
    local i = 3  -- Default to the lowest-priced backpack
    ...
    if Amount > 20475 then
        i = 4
    end
    
    if Amount > 70200 then
        i = 5
    end
    
    if Amount > 204750 then
        i = 6
    end
    
    if Amount > 292500 then
        i = 7
    end
    
    if Amount > 438750 then
        i = 8
    end
    
    if Amount > 877500 then
        i = 9
    end
    
    if Amount > 1462500 then
        i = 10
    end
    
    if Amount > 2047500 then
        i = 11
    end
    
    if Amount > 4212000 then
        i = 12
    end
    
    if Amount > 8775000 then
        i = 13
    end
    
    if Amount > 11700000 then
        i = 14
    end
    
    if Amount > 15210000 then
        i = 15
    end
    
    if Amount > 17550000 then
        i = 16
    end
    
    if Amount > 21937500 then
        i = 17
    end
    
    if Amount > 26325000 then
        i = 18
    end
    
    if Amount > 40950000 then
        i = 19
    end
    
    if Amount > 70200000 then
        i = 20
    end
    
    if Amount > 105300000 then
        i = 21
    end
    
    if Amount > 140400000 then
        i = 22
    end
    
    if Amount > 321750000 then
        i = 23
    end
    
    if Amount > 468000000 then
        i = 24
    end
    
    if Amount > 994500000 then
        i = 25
    end
    
    if Amount > 1696500000 then
        i = 26
    end
    
    -- Update the purchasedBackpack if a higher-priced backpack is purchased
    if i >= purchasedBackpack then
        purchasedBackpack = i
...
--HumanoidRootPart.CFrame = CFrame.new(55.2, 14.7, 26366.9)
HumanoidRootPart.CFrame = CFrame.new(-116, 13, 38)
Remote:FireServer("SellItems",{{               }})
HumanoidRootPart.Anchored = true
wait()
if HumanoidRootPart.CFrame ~= saved then
